<%@ page language="java" contentType="text/html;charset=UTF-8" pageEncoding="UTF-8"%>
     <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
   		...
   		<form id='actionForm' action="/admin/userSearch" method="get">
  ...
  <div style="width:100%; height:100%; min-height: 650px">
   <div class="dropdown">
      ...
      <div class="dropdown-content">
        <a href="/admin/userSearch?pageNum=1&amount=5&member_no=${member_no }">5개씩보기</a>
        <a href="/admin/userSearch?pageNum=1&amount=10&member_no=${member_no }">10개씩보기</a>
        <a href="/admin/userSearch?pageNum=1&amount=20&member_no=${member_no }">20개씩보기</a>
      </div>
    </div>
