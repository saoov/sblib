		...
		<div id='jun'>
			<table class="table table-bordered">
			    ...
			    <tr>
			      <th scope="col">기간</th>
			      <td>
			      	<input class = "form-control" id = "startDate" type = "text" name = "startDate" id = "startDate" style="width:120px; float:left;">
			     	<p style="float:left">~</p>
			     	<input class = "form-control" id = "endDate" type = "text" name = "endDate" id = "endDate" style="width:120px;">
			      </td>
			    </tr>
			    <tr>
			      <th scope="col">내용</th>
			      <td><textarea class="summernote" id="exampleFormControlTextarea1" rows="10"></textarea></td>
			    </tr>
			</table>
			<button type="button" class="btn btn-primary" style="position:absolute; right:0">등록</button>
		</div>
</div>
